...
class Client {
  ...
  */
  help() {
    this.writeln(`
This REPL has a client object with member functions. Visit github repo: https://github.com/cjus/hrmc

  client.help();                        Display this help
  client.open('ws://localhost:5353');   Open connection to HydraRouter
  client.close();                       Close connection to HydraRouter
  client.reopen();                      Reopen connection to HydraRouter
  client.createMessage();               Create a UMF message
  client.sendMessage('{UMF}');          Send a UMF message to HydraRouter`);
  }
}
